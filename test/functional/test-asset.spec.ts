...
describe('Get /assets', () => {
  ...
  it('Should return 302 for assets that are found', async () => {
    ...
    await populateCollection('assets', [{ fileName: 'elife-54296-fig1.tif', assetId: '0000-0000-0000-0000', articleId: '54296' }]);
  ...
  it('Should return asset with uuid path or just fileName', async () => {
    ...
    const resp1 = await agent
      .get('/articles/54296/assets/0000-0000-0000-0000/elife-54296-fig1.tif')
      .expect(302);
    ...
    expect(resp1.text).toContain('Found. Redirecting to http://localhost:4566/editor/54296/0000-0000-0000-0000/elife-54296-fig1.tif');
    expect(resp2.text).toContain('Found. Redirecting to http://localhost:4566/editor/54296/0000-0000-0000-0000/elife-54296-fig1.tif');
  });
});
