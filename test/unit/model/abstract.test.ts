...
describe('Manuscript state factory', () => {
    ...
    it('serializes abstract', () => {
        ...
        expect(xmlDoc.querySelector('abstract')!.textContent).toBe('additional content. Initial abstract content');
    });
    ...
    it('serializes impact statement', () => {
        ...
        expect(xmlDoc.querySelector('abstract')!.textContent).toBe(
            'additional content. Initial impact statement content',
        );
    });
