...
describe('deserializeChanges', () => {
                    ...
                    transactionSteps: [
                        {
                            ...
                            slice: {
                                content: [
                                    { type: 'refCitation', attrs: { refId: 'bib2', refText: 'Foox et al., 2011' } },
                                ],
                            },
                        },
                    ],
    ...
    it('filters out unsupported change types', () => {
        expect(
            ...
            '[{"type":"prosemirror","timestamp":1612261319184,"path":"body","transactionSteps":[{"stepType":"replace","from":0,"to":0,"slice":{"content":[{"text":"some new text","type":"text"}]}}]}]',
        );
    });
...
describe('applyChangesToManuscript', () => {
    ...
    it('applies a prosemirror change on the body', () => {
        ...
        const updatedManuscript = applyChangesToManuscript(mockManuscript, [
            createProsemirrorChange('body', 'some new body'),
        ]);
    ...
    it('applies a prosemirror change on the title', () => {
        ...
        const updatedManuscript = applyChangesToManuscript(mockManuscript, [
            createProsemirrorChange('title', 'some new title'),
        ]);
    ...
    it('applies a prosemirror change on the abstract', () => {
        ...
        const updatedManuscript = applyChangesToManuscript(mockManuscript, [
            createProsemirrorChange('abstract', 'some new abstract'),
        ]);
    ...
    it('applies a prosemirror change on the impactStatement', () => {
        ...
        const updatedManuscript = applyChangesToManuscript(mockManuscript, [
            createProsemirrorChange('impactStatement', 'some new impactStatement'),
        ]);
    ...
    it('applies a prosemirror change on the acknowledgements', () => {
        ...
        const updatedManuscript = applyChangesToManuscript(mockManuscript, [
            createProsemirrorChange('acknowledgements', 'some new acknowledgements'),
        ]);
